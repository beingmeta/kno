...
%attr(-,fdaemon,adm) %{_datadir}/locale/es/LC_MESSAGES/framerd.so
%attr(-,fdaemon,adm) %{_datadir}/locale/fr/LC_MESSAGES/framerd.so
%attr(-,fdaemon,adm) %{_datadir}/locale/nl/LC_MESSAGES/framerd.so
