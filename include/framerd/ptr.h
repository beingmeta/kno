...
FD_EXPORT lispval FDSYM_MERGE, FDSYM_SORT, FDSYM_SORTED, FDSYM_DEFAULT;
FD_EXPORT lispval FDSYM_LAZY, FDSYM_VERSION, FDSYM_ALWAYS;
FD_EXPORT lispval FDSYM_QUOTE, FDSYM_STAR, FDSYM_PLUS, FDSYM_NO, FDSYM_NONE;
FD_EXPORT lispval FDSYM_DOT, FDSYM_MINUS, FDSYM_EQUALS, FDSYM_QMARK;
FD_EXPORT lispval FDSYM_CONTENT, FDSYM_METADATA;
FD_EXPORT lispval FDSYM_OPT, FDSYM_OPTS, FDSYM_PROPS, FDSYM_MAIN, FDSYM_TEST;
FD_EXPORT lispval FDSYM_TEXT, FDSYM_LENGTH, FDSYM_TAG, FDSYM_CONS;
FD_EXPORT lispval FDSYM_STRING, FDSYM_FLAGS, FDSYM_KEYSLOT;
FD_EXPORT lispval FDSYM_PREFIX, FDSYM_SUFFIX, FDSYM_SEP;
FD_EXPORT lispval FDSYM_READONLY, FDSYM_ADJUNCT, FDSYM_ISADJUNCT;
FD_EXPORT lispval FDSYM_CACHELEVEL, FDSYM_SOURCE, FDSYM_FILE, FDSYM_FILENAME;
FD_EXPORT lispval FDSYM_INPUT, FDSYM_OUTPUT;
FD_EXPORT lispval FDSYM_ALL, FDSYM_CREATE, FDSYM_MODULE;
