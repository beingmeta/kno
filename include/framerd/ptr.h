...
FD_EXPORT lispval FDSYM_ADJUNCT, FDSYM_ALL, FDSYM_ALWAYS;
...
FD_EXPORT lispval FDSYM_DEFAULT, FDSYM_DOT, FDSYM_EQUALS;
FD_EXPORT lispval FDSYM_FILE, FDSYM_FILENAME;
FD_EXPORT lispval FDSYM_FLAGS, FDSYM_INPUT;
...
FD_EXPORT lispval FDSYM_NAME, FDSYM_NO, FDSYM_NONE;
...
FD_EXPORT lispval FDSYM_SIZE, FDSYM_SORT, FDSYM_SORTED;
...
FD_EXPORT lispval FDSYM_ADD, FDSYM_DROP, FDSYM_STORE;
FD_EXPORT lispval FDSYM_VERSION;
