...
#define FD_INDEX_FIELDS \
  ...
  fdb_flags index_flags, modified_flags;			   \
  int index_serialno;						   \
...
fd_index (*fd_file_index_type)(u8_string spec,fdb_flags flags);
...
FD_EXPORT fd_index fd_open_index(u8_string,fdb_flags);
FD_EXPORT fd_index fd_get_index(u8_string,fdb_flags);
...
FD_EXPORT fd_index fd_use_index(u8_string spec,fdb_flags);
