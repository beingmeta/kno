...
#define FD_DTSTREAM_FLAG_BASE      (1<<12)
#define FD_DTSTREAM_READING        (FD_DTSTREAM_FLAG_BASE * 1)
#define FD_DTSTREAM_READ_ONLY      (FD_DTSTREAM_FLAG_BASE * 2)
#define FD_DTSTREAM_CANSEEK        (FD_DTSTREAM_FLAG_BASE * 4)
#define FD_DTSTREAM_NEEDS_LOCK     (FD_DTSTREAM_FLAG_BASE * 8)
#define FD_DTSTREAM_LOCKED         (FD_DTSTREAM_FLAG_BASE * 16)
#define FD_DTSTREAM_SOCKET         (FD_DTSTREAM_FLAG_BASE * 32)
#define FD_DTSTREAM_DOSYNC         (FD_DTSTREAM_FLAG_BASE * 64)
