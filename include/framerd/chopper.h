...
#endif
FD_EXPORT void fd_initialize_nlp(void);
FD_EXPORT void fd_set_lexicon_source(char *directory);
...
typedef struct PARSE_CONTEXT {
  ...
  /* Frame generation */
  fd_pool parse_pool;} *parse_context;

FD_EXPORT void fd_initialize_chopper() FD_LIBINIT_FN;
