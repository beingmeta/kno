...
#define FD_VOID_OPCODE        FD_SPECIAL_OPCODE(0x08)
...
#define FD_AMBIGP_OPCODE      ND_ND1_OPCODE(0x01)
#define FD_SINGLETONP_OPCODE  ND_ND1_OPCODE(0x02)
#define FD_FAILP_OPCODE       ND_ND1_OPCODE(0x03)
#define FD_EXISTSP_OPCODE     ND_ND1_OPCODE(0x04)
#define FD_SINGLETON_OPCODE   ND_ND1_OPCODE(0x05)
#define FD_CAR_OPCODE         ND_ND1_OPCODE(0x06)
#define FD_CDR_OPCODE         ND_ND1_OPCODE(0x07)
#define FD_LENGTH_OPCODE      ND_ND1_OPCODE(0x08)
#define FD_QCHOICE_OPCODE     ND_ND1_OPCODE(0x09)
#define FD_CHOICE_SIZE_OPCODE ND_ND1_OPCODE(0x0a)
#define FD_PICKOIDS_OPCODE    ND_ND1_OPCODE(0x0b)
#define FD_PICKSTRINGS_OPCODE ND_ND1_OPCODE(0x0c)
#define FD_PICKONE_OPCODE     ND_ND1_OPCODE(0x0d)
#define FD_IFEXISTS_OPCODE    ND_ND1_OPCODE(0x0e)
...
#define FD_NULLP_OPCODE      FD_D1_OPCODE(0x07)
...
#define FD_FIRST_OPCODE      FD_D1_OPCODE(0x0b)
#define FD_SECOND_OPCODE     FD_D1_OPCODE(0x0c)
#define FD_THIRD_OPCODE      FD_D1_OPCODE(0x0d)
#define FD_CADR_OPCODE       FD_D1_OPCODE(0x0e)
#define FD_CDDR_OPCODE       FD_D1_OPCODE(0x0f)
#define FD_CADDR_OPCODE      FD_D1_OPCODE(0x10)
#define FD_CDDDR_OPCODE      FD_D1_OPCODE(0x11)
#define FD_TONUMBER_OPCODE   FD_D1_OPCODE(0x12)
...
#define FD_ND2_OPCODE(x)     FD_OPCODE(0x400+x)
#define FD_ND2_OPCODEP(x)    ((x>FD_OPCODE(0x400))&&(x<FD_OPCODE(0x500))
#define FD_IDENTICAL_OPCODE  FD_SET_OPCODE(0x01)
#define FD_OVERLAPS_OPCODE   FD_SET_OPCODE(0x02)
#define FD_CONTAINSP_OPCODE  FD_SET_OPCODE(0x03)
#define FD_UNION_OPCODE      FD_SET_OPCODE(0x04)
#define FD_INTERSECT_OPCODE  FD_SET_OPCODE(0x05)
#define FD_DIFFERENCE_OPCODE FD_SET_OPCODE(0x06)
#define FD_EQ_OPCODE         FD_SET_OPCODE(0x07)
#define FD_EQV_OPCODE        FD_SET_OPCODE(0x08)
#define FD_EQUAL_OPCODE      FD_SET_OPCODE(0x09)
#define FD_ELT_OPCODE        FD_SET_OPCODE(0X0A)
#define FD_MAX_ND2OPCODE     FD_SET_OPCODE(0xA0)
 
#define FD_ND3_OPCODE(x)     FD_OPCODE(0x500+x)
#define FD_ND3_OPCODEP(x)    ((x>FD_OPCODE(0x500))&&(x<FD_OPCODE(0x600))
