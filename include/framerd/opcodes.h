...
#define FD_EQ_OPCODE           FD_ND2_OPCODE(0x07)
#define FD_EQV_OPCODE          FD_ND2_OPCODE(0x08)
#define FD_EQUAL_OPCODE        FD_ND2_OPCODE(0x09)
#define FD_ELT_OPCODE          FD_ND2_OPCODE(0X0A)
#define FD_MAX_ND2OPCODE       FD_ND2_OPCODE(0xA0)
