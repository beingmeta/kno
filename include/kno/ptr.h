...
#define KNO_EOD			   KNO_CONSTANT(7)
#define KNO_EOF			   KNO_CONSTANT(8)
#define KNO_EOX			   KNO_CONSTANT(9)
#define KNO_XFORMAT_ERROR	   KNO_CONSTANT(10)
...
#define KNO_ABORTP(x) \
  (((KNO_TYPEP(x,kno_constant_type)) && \
    (KNO_GET_IMMEDIATE(x,kno_constant_type)>8) && \
...
KNO_EXPORT lispval KNOSYM_ADD, KNOSYM_ADDS, KNOSYM_ADJUNCT, KNOSYM_ALL;
KNO_EXPORT lispval KNOSYM_ALWAYS, KNOSYM_ARG, KNOSYM_ATMARK;
KNO_EXPORT lispval KNOSYM_BLOCKSIZE, KNOSYM_BUFSIZE;
KNO_EXPORT lispval KNOSYM_CACHE, KNOSYM_CACHED, KNOSYM_CACHELEVEL, KNOSYM_CACHESIZE;
KNO_EXPORT lispval KNOSYM_CONS, KNOSYM_CONTENT, KNOSYM_CREATE;
KNO_EXPORT lispval KNOSYM_DEFAULT, KNOSYM_DRIVER, KNOSYM_DOT, KNOSYM_DROP, KNOSYM_DROPS;
...
KNO_EXPORT lispval KNOSYM_LABEL, KNOSYM_LAZY, KNOSYM_LENGTH, KNOSYM_LOAD, KNOSYM_LOCK, KNOSYM_LOCKS;
KNO_EXPORT lispval KNOSYM_LOGLEVEL, KNOSYM_LT, KNOSYM_LTE;
...
KNO_EXPORT lispval KNOSYM_SECRET, KNOSYM_SEP, KNOSYM_SESSION;
KNO_EXPORT lispval KNOSYM_SET, KNOSYM_SIZE, KNOSYM_SORT, KNOSYM_SORTED;
KNO_EXPORT lispval KNOSYM_SOURCE, KNOSYM_STAR, KNOSYM_STORE, KNOSYM_STORES;
KNO_EXPORT lispval KNOSYM_STRING, KNOSYM_SUFFIX;
KNO_EXPORT lispval KNOSYM_TAG, KNOSYM_TEST, KNOSYM_TEXT, KNOSYM_TYPE;
KNO_EXPORT lispval KNOSYM_UNSUPPORTED, KNOSYM_UTF8;
