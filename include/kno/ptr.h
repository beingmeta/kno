...
KNO_EXPORT lispval KNOSYM_DEFAULT, KNOSYM_DOT, KNOSYM_DROP;
...
KNO_EXPORT lispval KNOSYM_PCTID, KNOSYM_PLUS, KNOSYM_PREFIX, KNOSYM_PROPS;
...
KNO_EXPORT lispval KNOSYM_SOURCE, KNOSYM_STAR, KNOSYM_STRING, KNOSYM_SUFFIX;
KNO_EXPORT lispval KNOSYM_TAG, KNOSYM_TEST, KNOSYM_TEXT, KNOSYM_TYPE;
KNO_EXPORT lispval KNOSYM_STORE;
