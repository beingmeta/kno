...
#define KNO_QONSTREF_OPCODE	 KNO_SPECIAL_OPCODE(0x08)
#define KNO_JIT_OPCODE		 KNO_SPECIAL_OPCODE(0x09)
#define KNO_BIND_OPCODE		 KNO_SPECIAL_OPCODE(0x0A)
#define KNO_VOID_OPCODE		 KNO_SPECIAL_OPCODE(0x0B)
#define KNO_TRY_OPCODE		 KNO_SPECIAL_OPCODE(0x0C)
#define KNO_AND_OPCODE		 KNO_SPECIAL_OPCODE(0x0D)
#define KNO_OR_OPCODE		 KNO_SPECIAL_OPCODE(0x0E)
#define KNO_SOURCEREF_OPCODE	 KNO_SPECIAL_OPCODE(0x0F)
#define KNO_RESET_ENV_OPCODE	 KNO_SPECIAL_OPCODE(0x10)
#define KNO_XREF_OPCODE		 KNO_SPECIAL_OPCODE(0x11)
#define KNO_XPRED_OPCODE	 KNO_SPECIAL_OPCODE(0x12)
#define KNO_BREAK_OPCODE	 KNO_SPECIAL_OPCODE(0x13)
#define KNO_UNION_OPCODE	 KNO_SPECIAL_OPCODE(0x14)
#define KNO_INTERSECT_OPCODE	 KNO_SPECIAL_OPCODE(0x15)
#define KNO_DIFFERENCE_OPCODE	 KNO_SPECIAL_OPCODE(0x16)
#define KNO_EVALFN_OPCODE	 KNO_SPECIAL_OPCODE(0x17)
#define KNO_APPLY_OPCODE	 KNO_SPECIAL_OPCODE(0x18)
#define KNO_ISA_OPCODE		 KNO_SPECIAL_OPCODE(0x19)
#define KNO_ISA_ALL_OPCODE	 KNO_SPECIAL_OPCODE(0x1A)
#define KNO_ISA_ANY_OPCODE	 KNO_SPECIAL_OPCODE(0x1B)
#define KNO_PICK_TYPE_OPCODE	 KNO_SPECIAL_OPCODE(0x1C)
#define KNO_SKIP_TYPE_OPCODE	 KNO_SPECIAL_OPCODE(0x1D)
#define KNO_CHECK_TYPE_OPCODE	 KNO_SPECIAL_OPCODE(0x1E)
#define KNO_LOCALS_OPCODE	 KNO_SPECIAL_OPCODE(0x1F)
