/* -*-C-*-
    ...
    Copyright (c) 2001-2006 beingmeta, inc.
...
{
  if (fd_unparsers[fd_double_type] == NULL)
    fd_unparsers[fd_double_type]=unparse_double;
...
/* The CVS log for this file
   $Log: numbers.c,v $
   Revision 1.42  2006/02/11 18:02:53  haase
   Fixed bug in parsing ints too big to be fixnums

   Revision 1.41  2006/02/03 20:06:50  haase
   Fixed bug with 0000 number parsing

   Revision 1.40  2006/02/03 19:04:15  haase
   Made base argument trump actual syntax

   Revision 1.39  2006/01/27 16:40:43  haase
   Fixed fixnum overflow errors

   Revision 1.38  2006/01/26 14:44:32  haase
   Fixed copyright dates and removed dangling EFRAMERD references

   Revision 1.37  2006/01/20 04:08:06  haase
   Fixed a temporary buffer leak case for number parsing

   Revision 1.36  2006/01/17 00:06:56  haase
   Fixed bug in rational to double conversion

   Revision 1.35  2006/01/07 19:08:33  haase
   Added fd_bigint2uint and support

   Revision 1.34  2006/01/04 20:05:50  haase
   Fix to flonum output, better solution needed

   Revision 1.33  2005/12/26 20:14:26  haase
   Further fixes to type reorganization

   Revision 1.32  2005/12/24 16:17:19  haase
   Added flonum parsing without leading zero

   Revision 1.31  2005/12/24 15:24:32  haase
   Made flonum printing always use decimal point

   Revision 1.30  2005/12/23 16:45:00  haase
   Added ability to parse engineering notation

   Revision 1.29  2005/12/22 18:57:31  haase
   Fixed bug in fits_in_wordp

   Revision 1.28  2005/12/20 20:45:04  haase
   Fixed various bigint bugs, especially parsing and GCD/LCM

   Revision 1.27  2005/12/20 19:05:16  haase
   Added fd_ulong_to_bigint and fixed some typos

   Revision 1.26  2005/12/19 18:36:37  haase
   Added hash methods for bignums and doubles

   Revision 1.25  2005/12/19 00:41:29  haase
   Added external access to GCD and LCM functions

   Revision 1.24  2005/12/18 02:09:08  haase
   Test fixes and makefile targets

   Revision 1.23  2005/12/17 17:34:35  haase
   Fixes to sign problems with bignums

   Revision 1.22  2005/12/17 05:58:25  haase
   Fixes to number parsing

   Revision 1.21  2005/12/13 19:21:26  haase
   Added divide by zero errors

   Revision 1.20  2005/11/03 14:06:09  haase
   Added fd_todouble

   Revision 1.19  2005/08/10 06:34:09  haase
   Changed module name to fdb, moving header file as well

   Revision 1.18  2005/06/22 22:50:43  haase
   Added inexact/exact conversions

   Revision 1.17  2005/06/20 01:51:44  haase
   Made bigints handle alternate CONS headers

   Revision 1.16  2005/05/30 18:04:43  haase
   Removed legacy numeric plugin layer

   Revision 1.15  2005/05/30 17:49:59  haase
   Distinguished FD_QCOMPARE and FDTYPE_COMPARE

   Revision 1.14  2005/05/19 22:06:07  haase
   Added full support for rationals and complex numbers

   Revision 1.13  2005/05/18 19:25:20  haase
   Fixes to header ordering to make off_t defaults be pervasive

   Revision 1.12  2005/05/10 18:43:35  haase
   Added context argument to fd_type_error

   Revision 1.11  2005/05/02 04:26:22  haase
   Various include and declaration fixes

   Revision 1.10  2005/04/25 19:15:06  haase
   Added modular extensible _fd_numberp

   Revision 1.9  2005/04/15 14:37:35  haase
   Made all malloc calls go to libu8

   Revision 1.8  2005/04/14 00:31:17  haase
   Made fd_long_to_bigint to return a fixnum if possible

   Revision 1.7  2005/04/11 21:28:24  haase
   Fix bugs in error propogation for comparisons

   Revision 1.6  2005/03/30 14:48:43  haase
   Extended error reporting to distinguish context discrimination (a const string) from details (malloc'd)

   Revision 1.5  2005/03/25 19:49:47  haase
   Removed base library for eframerd, deferring to libu8

   Revision 1.4  2005/03/24 17:41:42  haase
   Add some more copyright explanation

   Revision 1.3  2005/03/23 03:39:35  haase
   Added DTYPE dumping and restore of timestamps

   Revision 1.2  2005/03/17 02:27:51  haase
   Fixes to bignum/number handling

   Revision 1.1  2005/03/16 22:22:46  haase
   Added bignums

   Revision 1.5  2004/07/20 09:16:15  haase
   Updated copyright year, removed dead code, and cleaned up some whitespace

   Revision 1.4  2004/05/10 15:53:40  haase
   Fixed big in bigint remainder function

   Revision 1.3  2003/10/06 11:06:17  haase
   Fixed many malloc/u8_malloc/fd_xmalloc inconsistencies

   Revision 1.2  2002/04/02 21:41:08  haase
