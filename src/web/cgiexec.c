...
static lispval httpheader(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval htmlheader(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval title_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  U8_OUTPUT out; lispval result;
  U8_INIT_OUTPUT(&out,64);
  u8_puts(&out,"<title>");
...
static lispval jsout_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  U8_OUTPUT *prev = u8_current_output;
...
static lispval cssout_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  U8_OUTPUT *prev = u8_current_output;
...
static lispval withreqout_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
