...
DEFCPRIM("response/status?",testresponseprim,
 ...
 "`(RESPONSE/STATUS? *arg0* *arg1* [*arg2*])` "
 "**undocumented**",
	 {"response",kno_any_type,KNO_VOID},
...
static void link_local_cprims()
{
  ...
  KNO_LINK_CPRIM("response/notfound?",responsenotfoundp,1,webtools_module);
  KNO_LINK_CPRIM("response/badmethod?",responsebadmethodp,1,webtools_module);
  KNO_LINK_CPRIM("response/timeout?",responsetimeoutp,1,webtools_module);
  KNO_LINK_CPRIM("response/forbidden?",responseforbiddenp,1,webtools_module);
  KNO_LINK_CPRIM("response/unauthorized?",responseunauthorizedp,1,webtools_module);
  KNO_LINK_CPRIM("response/servererror?",responseservererrorp,1,webtools_module);
  KNO_LINK_CPRIM("response/myerror?",responsemyerrorp,1,webtools_module);
