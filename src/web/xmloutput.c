...
static lispval xmlout_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval raw_xhtml_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  lispval body = kno_get_body(expr,1);
  U8_OUTPUT *out = u8_current_output, tmpout;
  lispval xmloidfn = kno_symeval(xmloidfn_symbol,env);
...
static lispval xmlentry_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  U8_OUTPUT *out = u8_current_output;
...
static lispval xmlstart_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  U8_OUTPUT *out = u8_current_output;
  lispval head = kno_get_arg(expr,1), args = KNO_CDR(KNO_CDR(expr));
  u8_byte tagbuf[128]; u8_string tagname;
...
static lispval doxmlblock(lispval expr,kno_lexenv env,
                          kno_eval_stack _stack,int newline)
{
...
static lispval xmlblock_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  return doxmlblock(expr,env,_stack,0);
}
/* Does a block and wraps content in newlines */
static lispval xmlblockn_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  return doxmlblock(expr,env,_stack,1);
}

static lispval handle_markup(lispval expr,kno_lexenv env,kno_eval_stack _stack,
                             int star,int block)
{
...
static lispval markup_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  return handle_markup(expr,env,_stack,0,0);
}

static lispval markupblock_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  return handle_markup(expr,env,_stack,0,1);
}

static lispval markupstarblock_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  return handle_markup(expr,env,_stack,1,1);
}

static lispval markupstar_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  return handle_markup(expr,env,_stack,1,0);
}

static lispval emptymarkup_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  u8_byte tagbuf[128];
  U8_OUTPUT *out = u8_current_output;
...
static lispval doanchor_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  U8_OUTPUT *out = u8_current_output, tmpout;
...
static lispval doanchor_star_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  U8_OUTPUT *out = u8_current_output, tmpout;
...
static lispval xmleval_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval xmlopen_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval javascript_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval javastmt_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  lispval retval; struct U8_OUTPUT out; U8_INIT_OUTPUT(&out,256);
  retval = output_javascript(&out,KNO_CDR(expr),env);
  if (VOIDP(retval)) {
...
static lispval soapenvelope_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  U8_OUTPUT *out = u8_current_output;
