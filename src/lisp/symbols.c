...
lispval FDSYM_FLAGS, FDSYM_FORMAT, FDSYM_FRONT, FDSYM_HISTORY_THREADVAL;
lispval FDSYM_INPUT, FDSYM_ISADJUNCT, FDSYM_KEYSLOT;
...
lispval FDSYM_PCTID, FDSYM_PLUS;
lispval FDSYM_PREFIX, FDSYM_PROPS;
...
static void init_builtin_symbols()
{
  ...
  FDSYM_HISTORY_THREADVAL = kno_intern("%history");
