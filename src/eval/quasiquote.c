      ...
      if (FD_BAD_UNQUOTEP(elt)) {
        ...
        if (level==1) {
          ...
          if (FD_ABORTED(insertion)) {
            ...
            fdtype scan = insertion, last = VOID;
      ...
      if ((PAIRP(elt)) &&
        ...
        if (level==1) {
          ...
          if (NILP(insertion)) {}
            ...
            fdtype scan = insertion; while (PAIRP(scan)) {
          ...
          if (PAIRP(insertion)) {
            ...
            int k = 0; while (k<addlen) {
              fdtype ielt = VEC_REF(insertion,k);
