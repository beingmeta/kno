...
static lispval evaltest_evalfn(lispval expr,kno_lexenv env,struct KNO_EVAL_STACK *s)
{
...
static lispval errtest_evalfn(lispval expr,kno_lexenv env,struct KNO_EVAL_STACK *s)
{
