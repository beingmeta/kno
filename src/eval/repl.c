...
(lispval expr,kno_lexenv env,kno_eval_stack stack)
{
...
{
  KNO_LINK_PRIM("histref",histref_prim,2,repl_module);
  KNO_LINK_PRIM("histfind",histfind_prim,2,repl_module);
  KNO_LINK_PRIM("histadd!",histadd_prim,3,repl_module);
}
