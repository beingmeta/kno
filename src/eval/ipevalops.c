...
static lispval letq_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval ipeval_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval trace_ipeval_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval track_ipeval_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  struct IPEVAL_STRUCT tmp;
