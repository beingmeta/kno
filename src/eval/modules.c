...
static lispval in_module_evalfn(lispval expr,kno_lexenv env,struct KNO_EVAL_STACK *_stack)
{
...
static lispval within_module_evalfn(lispval expr,kno_lexenv env,struct KNO_EVAL_STACK *_stack)
{
  lispval module_name = kno_get_arg(expr,1);
  if (VOIDP(module_name))
...
static lispval accessing_module_evalfn(lispval expr,kno_lexenv env,struct KNO_EVAL_STACK *_stack)
{
...
static lispval module_export_evalfn(lispval expr,kno_lexenv env,struct KNO_EVAL_STACK *stack)
{
  kno_hashtable exports;
...
static lispval use_module_evalfn(lispval expr,kno_lexenv env,struct KNO_EVAL_STACK *_stack)
{
  return use_module_helper(expr,env);
}

static lispval export_alias_helper(lispval expr,kno_lexenv env,struct KNO_EVAL_STACK *_stack)
{
...
static lispval export_alias_evalfn(lispval expr,kno_lexenv env,struct KNO_EVAL_STACK *_stack)
{
