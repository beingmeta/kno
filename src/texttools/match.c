   ...
   u8_string string,u8_byteoff off,u8_byteoff lim,int flags)
{
  ...
  else if (FD_PRIM_TYPEP(pat,fd_txclosure_type)) {
...
{
  if (FD_PRIM_TYPEP(arg,fd_hashset_type)) 
   ...
   u8_string string,u8_byteoff off,u8_byteoff lim,int flags)
{
  ...
  else if (!(FD_PRIM_TYPEP(hs,fd_hashset_type)))
...
/* The CVS log for this file
   $Log: match.c,v $
   Revision 1.32  2006/02/16 06:07:33  haase
   Fix some leaks and double GCs

   Revision 1.31  2006/02/01 15:57:44  haase
   Improved some error passing in texttools

   Revision 1.30  2006/01/31 03:17:29  haase
   Fixed leaks in CHOICE matcher

   Revision 1.29  2006/01/27 22:04:49  haase
   Added CHOICE match operator

   Revision 1.28  2006/01/26 22:06:33  haase
   Fixed UTF-8 handling bug

   Revision 1.27  2006/01/26 17:49:45  haase
   Cleaned up and documented the text matcher model and internals

   Revision 1.26  2006/01/26 14:44:33  haase
   Fixed copyright dates and removed dangling EFRAMERD references

   Revision 1.25  2006/01/26 14:22:54  haase
   Minor name changes for export

   Revision 1.24  2006/01/24 23:04:29  haase
   Changed internal match/extract API to allow a next pattern pointer and implement the (*) wildcard

   Revision 1.23  2006/01/21 20:15:20  haase
   Added ability to have transformation functions in SUBST matcher expressions

   Revision 1.22  2005/12/31 20:53:49  haase
   Fixed bug in search with choice patterns introduced by CHOICE cleanup

   Revision 1.21  2005/12/30 18:35:53  haase
   Minor whitespace changes

   Revision 1.20  2005/12/23 17:05:05  haase
   Fixed matcher to normalize and iterate over achoices

   Revision 1.19  2005/12/22 15:46:28  haase
   Fixed text amatching leak

   Revision 1.18  2005/12/22 14:35:55  haase
   Fixed some leaks in text matching

   Revision 1.17  2005/12/20 17:49:11  haase
   Made isalpha+ handle greediness

   Revision 1.16  2005/12/13 22:43:02  haase
   Fixed bug with gather and text->frames where matched regions adjoined each other

   Revision 1.15  2005/09/16 17:28:15  haase
   Fix error message

   Revision 1.14  2005/08/30 21:03:42  haase
   Fixed fencepost error in text matcher

   Revision 1.13  2005/08/10 06:34:09  haase
   Changed module name to fdb, moving header file as well

   Revision 1.12  2005/07/21 03:06:14  haase
   Fixed matching bug with empty strings

   Revision 1.11  2005/07/19 20:12:49  haase
   Fixed some text matching bugs

   Revision 1.10  2005/07/19 01:09:50  haase
   Fixed bug in OPT match handler

   Revision 1.9  2005/07/06 14:55:59  haase
   Added greedy matching to text matching, etc

   Revision 1.8  2005/07/04 13:39:46  haase
   Added more text processing utilities, including TEXTSLICE, TEXT->FRAME, AND TEXT->FRAMES

   Revision 1.7  2005/06/20 20:51:02  haase
   Fixed spelling of ISVOWEL and added ISNOTVOWEL

   Revision 1.6  2005/06/15 02:00:28  haase
   Added ISVOWEL match primitive

   Revision 1.5  2005/06/15 01:19:45  haase
   Added log entries to texttools files

   Revision 1.4  2005/06/14 18:55:07  haase
   Added U8 optimization options to texttools files

   Revision 1.3  2005/06/02 03:31:28  haase
   Added OPT, textclosures, and better error passing to the text module

   Revision 1.2  2005/05/30 03:43:52  haase
   Added more matcher functionality

   Revision 1.1  2005/05/24 00:20:46  haase
   Added text matcher
