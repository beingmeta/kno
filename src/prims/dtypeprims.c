...
DEFPRIM3("dtype->file",lisp2file,KNO_MAX_ARGS(3)|KNO_MIN_ARGS(2)|KNO_NDOP,
...
DEFPRIM3("dtype->zfile",lisp2zipfile,KNO_MAX_ARGS(3)|KNO_MIN_ARGS(2)|KNO_NDOP,
...
DEFPRIM2("dtypes->file+",add_dtypes2file,KNO_MAX_ARGS(2)|KNO_MIN_ARGS(2)|KNO_NDOP,
...
DEFPRIM2("dtype->zfile+",add_lisp2zipfile,KNO_MAX_ARGS(2)|KNO_MIN_ARGS(2)|KNO_NDOP,
...
static void link_local_cprims()
{
  ...
  KNO_LINK_PRIM("zfile->dtypes",zipfile2dtypes,1,dtypeprims_module);
  KNO_LINK_PRIM("zfile->dtype",zipfile2dtype,1,dtypeprims_module);
  KNO_LINK_PRIM("file->dtype",file2dtype,1,dtypeprims_module);
  KNO_LINK_PRIM("zfile->dtype",zipfile2dtype,1,dtypeprims_module);
  KNO_LINK_PRIM("dtype->zfile+",add_lisp2zipfile,2,dtypeprims_module);
  KNO_LINK_PRIM("dtypes->file+",add_dtypes2file,2,dtypeprims_module);
  KNO_LINK_PRIM("dtype->zfile+",add_lisp2zipfile,2,dtypeprims_module);
  KNO_LINK_PRIM("dtype->zfile",lisp2zipfile,3,dtypeprims_module);
  KNO_LINK_PRIM("dtype->file",lisp2file,3,dtypeprims_module);
  KNO_LINK_PRIM("dtype->zfile",lisp2zipfile,3,dtypeprims_module);
