...
DCLPRIM("STRING-APPEND",string_append_prim,KNO_VAR_ARGS,
...
DCLPRIM("STRING",string_prim,KNO_VAR_ARGS,
...
DCLPRIM2("MAKE-STRING",makestring_prim,MAX_ARGS(2)|MIN_ARGS(1),
         ...
         "to #\\Space",
         kno_fixnum_type,VOID,kno_character_type,KNO_VOID)
...
DCLPRIM3("STRMATCH?",strmatchp_prim,MIN_ARGS(2)|MAX_ARGS(3)|NDCALL,
         ...
         kno_string_type,VOID,-1,VOID,kno_fixnum_type,VOID)
...
DCLPRIM2("PACKET->STRING",packet2string,MAX_ARGS(2)|MIN_ARGS(1),
         ...
         "to UTF-8",
         kno_packet_type,KNO_VOID,-1,KNO_FALSE)
...
DCLPRIM3("STRING-SUBST",string_subst_prim,MAX_ARGS(3),
         ...
         kno_string_type,KNO_VOID,-1,KNO_VOID,kno_string_type,KNO_VOID)
...
DCLPRIM("STRING-SUBST*",string_subst_star,MIN_ARGS(3)|KNO_VAR_ARGS,
...
DCLPRIM("GLOM",glom_lexpr,MAX_ARGS(0)|KNO_VAR_ARGS,
...
KNO_EXPORT void kno_init_stringprims_c()
{
  ...
  DECL_PRIM(asciip,1,kno_scheme_module);
  DECL_PRIM(latin1p,1,kno_scheme_module);
  DECL_PRIM(lowercasep,1,kno_scheme_module);
  DECL_PRIM(uppercasep,1,kno_scheme_module);

  DECL_PRIM(utf8p_prim,1,kno_scheme_module);
  DECL_PRIM(utf8string_prim,1,kno_scheme_module);
  DECL_PRIM(string_byte_length,1,kno_scheme_module);
  DECL_PRIM(fixnuls_prim,1,kno_scheme_module);

  DECL_PRIM(char2integer,1,kno_scheme_module);
  DECL_PRIM(integer2char,1,kno_scheme_module);
  DECL_PRIM(char_alphabeticp,1,kno_scheme_module);
  DECL_PRIM(char_numericp,1,kno_scheme_module);
  DECL_PRIM(char_alphanumericp,1,kno_scheme_module);
  DECL_PRIM(char_punctuationp,1,kno_scheme_module);
  DECL_PRIM(char_whitespacep,1,kno_scheme_module);
  DECL_PRIM(char_upper_casep,1,kno_scheme_module);
  DECL_PRIM(char_lower_casep,1,kno_scheme_module);

  DECL_PRIM(char_downcase,1,kno_scheme_module);
  DECL_PRIM(downcase,1,kno_scheme_module);
  DECL_PRIM(char_upcase,1,kno_scheme_module);
  DECL_PRIM(upcase,1,kno_scheme_module);

  DECL_PRIM_N(string_eq,kno_scheme_module);
  DECL_PRIM_N(string_ci_eq,kno_scheme_module);
  DECL_PRIM_N(string_ne,kno_scheme_module);
  DECL_PRIM_N(string_ci_ne,kno_scheme_module);
  DECL_PRIM_N(string_lt,kno_scheme_module);
  DECL_PRIM_N(string_ci_lt,kno_scheme_module);
  DECL_PRIM_N(string_gt,kno_scheme_module);
  DECL_PRIM_N(string_ci_gt,kno_scheme_module);
  DECL_PRIM_N(string_gte,kno_scheme_module);
  DECL_PRIM_N(string_ci_gte,kno_scheme_module);
  DECL_PRIM_N(string_lte,kno_scheme_module);
  DECL_PRIM_N(string_ci_lte,kno_scheme_module);

  DECL_PRIM_N(char_eq,kno_scheme_module);
  DECL_PRIM_N(char_ci_eq,kno_scheme_module);
  DECL_PRIM_N(char_ne,kno_scheme_module);
  DECL_PRIM_N(char_ci_ne,kno_scheme_module);
  DECL_PRIM_N(char_lt,kno_scheme_module);
  DECL_PRIM_N(char_ci_lt,kno_scheme_module);
  DECL_PRIM_N(char_gt,kno_scheme_module);
  DECL_PRIM_N(char_ci_gt,kno_scheme_module);
  DECL_PRIM_N(char_gte,kno_scheme_module);
  DECL_PRIM_N(char_ci_gte,kno_scheme_module);
  DECL_PRIM_N(char_lte,kno_scheme_module);
  DECL_PRIM_N(char_ci_lte,kno_scheme_module);

  DECL_PRIM(capitalizedp,1,kno_scheme_module);
  DECL_PRIM(capitalize,1,kno_scheme_module);
  DECL_PRIM(capitalize1,1,kno_scheme_module);
  DECL_PRIM(symbolize_cprim,1,kno_scheme_module);

  DECL_PRIM(some_capitalizedp,2,kno_scheme_module);

  DECL_PRIM(empty_stringp,3,kno_scheme_module);
  DECL_PRIM(string_compoundp,1,kno_scheme_module);
  DECL_PRIM(string_multilinep,1,kno_scheme_module);
  DECL_PRIM(string_phrase_length,1,kno_scheme_module);

  DECL_PRIM(string_stdspace,2,kno_scheme_module);
  DECL_PRIM(string_stdcap,1,kno_scheme_module);
  DECL_PRIM(string_stdstring,1,kno_scheme_module);
  DECL_PRIM(string_basestring,1,kno_scheme_module);
  DECL_PRIM(string_startword,1,kno_scheme_module);
  DECL_PRIM(string_trigrams,1,kno_scheme_module);
  DECL_PRIM(string_bigrams,1,kno_scheme_module);

  DECL_PRIM(yesp_prim,4,kno_scheme_module);

  DECL_PRIM(stdobj,1,kno_scheme_module);

  DECL_PRIM(has_prefix,2,kno_scheme_module);
  DECL_PRIM(is_prefix,2,kno_scheme_module);
  DECL_PRIM(strip_prefix,2,kno_scheme_module);

  DECL_PRIM(has_suffix,2,kno_scheme_module);
  DECL_PRIM(is_suffix,2,kno_scheme_module);
  DECL_PRIM(strip_suffix,2,kno_scheme_module);

  DECL_PRIM_N(string_append_prim,kno_scheme_module);
  DECL_PRIM_N(string_prim,kno_scheme_module);
  DECL_PRIM(makestring_prim,2,kno_scheme_module);

  DECL_PRIM(string_subst_prim,3,kno_scheme_module);
  DECL_PRIM(trim_spaces,1,kno_scheme_module);
  DECL_PRIM(strmatchp_prim,3,kno_scheme_module);
  DECL_PRIM_N(string_subst_star,kno_scheme_module);

  DECL_PRIM_N(glom_lexpr,kno_scheme_module);

  DECL_PRIM(string2packet,3,kno_scheme_module);
  DECL_PRIM(packet2string,2,kno_scheme_module);
  DECL_PRIM(x2secret_prim,1,kno_scheme_module);
  DECL_PRIM(x2secret_prim,1,kno_scheme_module);
