...
static lispval simple_fileout_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval simple_system_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval snapshot_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
...
static lispval snapback_evalfn(lispval expr,kno_lexenv env,kno_eval_stack _stack)
{
  kno_lexenv save_env; u8_string save_file; int retval = 0;
  lispval arg1 = kno_eval(kno_get_arg(expr,1),env), arg2 = kno_eval(kno_get_arg(expr,2),env);
  if (VOIDP(arg1)) {
