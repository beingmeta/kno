...
DEFPRIM1("hyphenate-word",hyphenate_word_prim,KNO_MAX_ARGS(1)|KNO_MIN_ARGS(1),
...
DEFPRIM1("hyphen-breaks",hyphen_breaks_prim,KNO_MAX_ARGS(1)|KNO_MIN_ARGS(1),
...
DEFPRIM1("shyphenate",shyphenate_prim,KNO_MAX_ARGS(1)|KNO_MIN_ARGS(1),
...
DEFPRIM2("hyphenout",hyphenout_prim,KNO_MAX_ARGS(2)|KNO_MIN_ARGS(1),
...
DEFPRIM2("hyphenate",hyphenate_prim,KNO_MAX_ARGS(2)|KNO_MIN_ARGS(1),
