...
KNO_DEFPRIM2("zlib/compress",zlib_compress_prim,KNO_MAX_ARGS(2)|KNO_MIN_ARGS(1),
...
KNO_DEFPRIM3("zlib/uncompress",zlib_uncompress_prim,KNO_MAX_ARGS(3)|KNO_MIN_ARGS(1),
