...
static lispval config_get_module_loc(lispval var,void *which_arg)
{
  ...
  case LOCAL_SAFE_MODULES:
    return lispval_string(KNO_LOCAL_SAFE_MODULE_DIR);
  case INSTALLED_MODULES:
    return lispval_string(KNO_INSTALLED_MODULE_DIR);
  case INSTALLED_SAFE_MODULES:
    return lispval_string(KNO_INSTALLED_SAFE_MODULE_DIR);
  case BUILTIN_MODULES:
    return lispval_string(KNO_BUILTIN_MODULE_DIR);
  case BUILTIN_SAFE_MODULES:
    return lispval_string(KNO_BUILTIN_SAFE_MODULE_DIR);
  case UNPACKAGE_DIR:
...
KNO_EXPORT void kno_init_support_c()
{
  ...
  kno_register_config("LOCAL_SAFE_MODULES",_("value of LOCAL_SAFE_MODULES"),
  ...
  kno_register_config("INSTALLED_SAFE_MODULES",_("value of INSTALLED_SAFE_MODULES"),
  ...
  kno_register_config("SHARED_SAFE_MODULES",_("value of SHARED_SAFE_MODULES"),
                     config_get_module_loc,NULL,(void *) SHARED_SAFE_MODULES);
  kno_register_config("BUILTIN_MODULES",_("value of BUILTIN_MODULES"),
                     config_get_module_loc,NULL,(void *) BUILTIN_MODULES);
  kno_register_config("BUILTIN_SAFE_MODULES",_("value of BUILTIN_SAFE_MODULES"),
