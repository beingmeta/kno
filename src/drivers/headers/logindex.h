...
/* LOGINDEX indexes keep themselves in memory but support fast commits
...
/* The file layout has a 256-byte header block consisting of
     ...
     0x04 Number of keys (4 bytes)
     0x08 Number of entries (8 bytes)
     0x10 Valid data size (8 bytes)
     0x18 XREFS location (8 bytes)
     0x20 XREFS length (4 bytes)
