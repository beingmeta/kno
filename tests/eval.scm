...
(define-tester (test-coderefs)
  (let ((coderef (%coderef 16)))
    ...
    (errtest (%coderef (* 1024 1024 1024 1024 1024 1024 1024 1024 1024)))
...
(define-tester (test-bindings (p 3) (q) (z #default) (g #f) (r))
  ...
  ;; Maybe add these back with setfalse! macro'd to be (default! var val #f)
  (errtest (default! "g"))
  (errtest (default! g))
  (errtest (default! g (* 8 'p) #f))
  (errtest (default! gzt 9))
  (evaltest 'void (default! g 17 #f))
  (evaltest 'void (default! p 17))
