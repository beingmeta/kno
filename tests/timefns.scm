...
(applytest gmt-time1 gmtimestamp "2011-12-03T08:23:00")
...
(applytest #t > (microtime) (milltime) (time))
...
(let* ((now (timestamp))
       ...
       (moment (elapsed-time)))
  (applytest 86400 time-since yesterday)
  (applytest 86400 time-until tomorrow)
  (applytest -86400 time-since tomorrow)
  (applytest -86400 time-until yesterday)
  (applytest 172800 difftime tomorrow yesterday)
  (applytest -172800 difftime tomorrow yesterday)
  ...
  (applytest #f past? tommorrow)
  (applytest #f future? yesterday)
  (applytest #f future? tomorrow)
  ...
  (applytest "Mon, 3 Dec 1979 08:15:00 +0000" get bday 'rfc822)
  (applytest "Mon, 3 Dec 1979 03:15:00 -0500" get bday 'rfc822x)
  (applytest "Mon, 3 Dec 1979 03:15:00" get bday 'localstring)
  ...
  (applytest "Monday 03 December 1979 03:15:00 AM EST" get bday 'fullstring)
